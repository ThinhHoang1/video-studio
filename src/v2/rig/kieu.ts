 ...
 *
 * Mỗi người chỉ có: một kiểu tóc một màu, tối đa MỘT phụ kiện. Da, áo, quần
 * không tô (cùng màu nền). Đây là điều làm phong cách này đọc được ở mọi cỡ.
 */
...
export const KIEU: Record<string, Kieu> = {
  nam: {ten: 'Nam', toc: {mau: '#1c1a22', mai: 'hat', lon: 0, sau: 'ngan'}, phuKien: 'ca-vat', mauNhan: '#c0392b'},
  ha: {ten: 'Hà', toc: {mau: '#2b1a12', mai: 'lech-trai', lon: 2, sau: 'duoi-ngua'}, phuKien: 'no', mauNhan: '#c0392b'},
  long: {ten: 'Long', toc: {mau: '#3a2a1c', mai: 'dung', lon: 0, sau: 'ngan'}, phuKien: 'khong', co: 1.05},
  mai: {ten: 'Mai', toc: {mau: '#5a3b1e', mai: 'ngang', lon: 2, sau: 'bob'}, phuKien: 'kinh'},
  me: {ten: 'Mẹ', toc: {mau: '#2a2126', mai: 're-giua', lon: 0, sau: 'bui'}, phuKien: 'khong', khung: 'phu', co: 0.95},
  thay: {ten: 'Thầy', toc: {mau: '#8a8a8a', mai: 're-giua', lon: 0, sau: 'ngan'}, phuKien: 'kinh', khung: 'phu'},
  'nam-lon': {ten: 'Nam 30', toc: {mau: '#1c1a22', mai: 'lech-phai', lon: 0, sau: 'ngan'}, phuKien: 'khong', co: 1.05},
  'ha-lon': {ten: 'Hà 30', toc: {mau: '#2b1a12', mai: 'lech-trai', lon: 2, sau: 'dai'}, phuKien: 'khong'},
