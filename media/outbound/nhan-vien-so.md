...
**YouTube** (chọn 1, ưu tiên dòng đầu):

1. `Tôi mở công ty một người. Rồi tôi tự sa thải chính mình.` ← nghịch lý gói gọn trong một câu
2. `Nhà nước muốn 1 TRIỆU công ty một người. Tôi thử trước cho.`
3. `Lắp AI làm đủ ba phòng ban, tôi tưởng mình là tập đoàn`
4. `Công ty tôi có 1 nhân viên. Hôm tôi sốt 39 độ thì...`

**TikTok** (caption ngắn, không cần SEO):

1. `Tôi tự sa thải chính mình. Mà tôi là sếp 💀` ← mạnh nhất
2. `Cty tôi có 1 nhân viên. Là tôi.`
3. `AI của tôi nói chuyện với AI của khách. Suốt 4 ngày.`

**Chữ trên thumbnail** — 2 dòng, chữ to hết cỡ, ghép với mặt `avatar-2-soc.png`:
...
**Hashtag** — YouTube 5–8, TikTok chỉ 3–4:
`#doanhnghiepmotnguoi #nghiquyet86 #khoinghiep #AI #storytime #hoathinh #congso`

**Bình luận ghim** (đăng ngay sau khi lên video):

> Nguồn: Nghị quyết 86/NQ-CP — baochinhphu.vn · Báo cáo ILO 4/2026 (nhóm hành chính
> 64.9% rủi ro). Nhân vật và tình huống là hư cấu.
> Nhạc: Kevin MacLeod (incompetech.com), giấy phép CC BY 4.0.

## Số liệu dựng (máy ghi lại mỗi lần render)

<!-- BẢNG CHẤM: máy ghi, đừng sửa tay -->

- Giọng: Fenrir · 7 chương · project nhan-vien-so
...
```
nhan-vien-so — media/outbound/nhan-vien-so.mp4 — 130.4 s, 62 shot dò được
